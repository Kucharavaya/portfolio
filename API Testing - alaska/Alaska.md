...
- [Чек-лист](#title2)
- [Примеры Тест-кейсов в (Excel/Google Sheets)](#title3)
...
|-|-|					
| 0 - 100                | -0.01, 0, 0.01, 17.5, 99.99, 100, 100.01 |
...
| сСпецсимволы	         | нельзя определить                        |	

***
					
## <a id="title2">Чек-лист API Testing для CRUD-сервиса (Alaska):</a>
...
## <a id="title3">Примеры Тест-кейсов</a> `Excel/Google Sheets`. 
